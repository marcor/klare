...
top = \relative c' {
  ...
  \repeat volta 2 {
    \stemUp e16 c'8 e,16 c'8 e,16 c' ~ \stemNeutral | %5
    c4 ~ c16 <c' e, c> <d f, d> <dis fis, dis> |
    <e g, e> <c e, c> <d f, d> <e g, e> ~ <e g, e> <b d, b> <d f, d>8 |
    <c e, c>4 ~ <c e, c>8 \voiceOne d,,16( dis) \oneVoice |
    \stemUp e16 c'8 e,16 c'8 e,16 c'  ~ \stemNeutral | %9
    c4 ~ c8 <a' c, a>16 <g c, g> |
    <fis c fis,>16 <a a,> <c c,> <e e,> ~ <e e,> <d d,> <c c,> <a a,> |
    <d f,! d>4 ~ <d f, d>8 \voiceOne d,,16([ dis)] |
    e16 c'8 e,16 c'8 e,16 c' ~ \oneVoice | %13
    c4 ~ c16 <c' e, c> <d f, d> <dis fis, dis> |
    <e g, e> <c e, c> <d f, d> <e g, e> ~ <e g, e> <b d, b> <d f, d>8 |
  ...
  \repeat volta 2 {
    \voiceOne <g e g,>8^\markup \italic "Repeat 8va"  <a e a,>16 <g e g,> ~ <g e g,> <e c e,> <f d f,> <fis dis fis,> |
    ...
    c8 a16 c ~ c a c a |
    g c e g ~ g e c g |
    <a fis>8 <c fis,> <e f,>16 <d f,>8 <c e,>16 ~ \oneVoice |
  } \alternative {
  ...
  \voiceOne e16 c'8 e,16 c'8 e,16 c' ~ \oneVoice |
  c4 ~ c16 <c' e, c> <d f, d> <dis fis, dis> |
  <e g, e> <c e, c> <d f, d> <e g, e> ~ <e g, e> <b d, b> <d f, d>8 | %41
  <c e, c>4 ~ <c e, c>8 \voiceOne d,,16( dis) |
  e16 c'8 e,16 c'8 e,16 c' ~ \oneVoice |
  c4 ~ c8 <a' c, a>16 <g c, g> |
  ...
  \repeat volta 2 {
    ...
    << { <d bes f>2 } \\ { r8 \voiceThree bes,16 a bes c d8 \oneVoice } >> |
    <f d>16 e <f d>8 ~ <f d> <a f d> | %57
    << { <bes g d>4 ~ <bes g d>8. g16 } \\  { r8 \voiceThree g,16 fis  g a bes8 \oneVoice} >> |
    d8 g16 d ~ d g d8 |
    c4 f |
    ...
    c4 <f b, gis>8. f16 |
    <<
      { <a c, a>16 <c c,>8 <g bes,>16 ~ g c, d e }
  ...
  \stemUp c,8 a16 c ~ c a c a |
  g c e g ~ g e c g | %73
  <a fis>8 <c fis,> <e f,>16 <d f,>8 <c e,>16 ~ \stemNeutral |
  <c e,>4 <c' g e c>8 r |
  ...
  \repeat volta 2 {
    ...
    <g e>8 <fis dis>16 <g e> ~ <g e> <fis dis> <g e>8 |
    r16 c <e g,> c d e d c |
    \stemUp a gis a <g' a,> ~ <g a,> <f a,>8 <c a>16 |
    <e g,> dis e a ~ a c g e  | %89
    <c fis,>8 <c fis,> <e b f>16 <d b f>8 <c g e>16 ~ \stemNeutral|
  } \alternative {
...
\score {
  \new PianoStaff <<
    \new KlareStaff = "up" {
      <<
      \new Voice \staffFormat
      \new Voice \top
      >>
    }
    \new KlareStaff = "down" \bottom
    \new Dynamics \dyn
